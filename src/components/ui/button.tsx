...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        // Primary: One per screen - main call to action
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-md hover:-translate-y-0.5",
        
        // Secondary: Supporting actions
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 border border-border hover:shadow-sm hover:-translate-y-0.5",
        
        // Tertiary/Quiet: Low-emphasis actions
        ghost: "hover:bg-accent/50 hover:text-accent-foreground",
        
        // Outlined: Alternative secondary style
      ...
      size: {
        ...
        lg: "h-12 px-8 rounded-[var(--radius)]",
